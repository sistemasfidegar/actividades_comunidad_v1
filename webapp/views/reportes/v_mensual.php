...
<form id="filtros" name="filtros" method="post" action="index.php/reportes/generaMensual">
	<div class="row">        	
        	<div class="col-md-12">
 		...
 		<div class="row" style="display:<?php echo $display;?>;">        	
        	<div class="col-md-12" style="text-align:center !important;">
        		<div class="box box-solid box-success" style="text-align:center !important;  height:100%;">
						...
						?>
							<table width="100%" border="1" id="Exportar_a_Excel">
								<tr height="70px" bgcolor="#3F7788" style="font-weight:bold; font-size:18px;">
									...
									INFORME GENERAL MENSUAL<br />
									<?php echo mesEnLetras($mes);?> DE <?php echo $anio;?>
									</td>
								</tr>
							...
							foreach($delegaciones as $row)
							{
								...
								echo '<tr bgcolor="'.$color.'"><td align="left" style="padding-left:5px;">'.$delegacion.'</td><td>'.$td.'</td><td>'.$tv.'</td><td>'.$tc.'</td><td>'.$tp.'</td></tr>';
								$r++;
							}	
						...
						?>
							...
							<tr height="70px" bgcolor="#3F7788" style="font-weight:bold; font-size:18px;">
								<td colspan="9" align="center">
										INFORME GENERAL MENSUAL: EJES TEMATICOS<br />
										<?php echo mesEnLetras($mes);?> DE <?php echo $anio;?>
									</td>
							</tr>
							<tr height="40px" bgcolor="#3F7788" style="font-weight:bold; font-size:18px;">
						...
						?>
						<table width="100%" border="1" id="Exportar_a_Excel">
							<tr height="70px" bgcolor="#558690" style="font-weight:bold; font-size:18px;">
								<td colspan="2" align="center">
								INFORME GENERAL MENSUAL<br />
								<?php echo mesEnLetras($mes);?> DE <?php echo $anio;?>
								</td>
							</tr>
							<tr height="40px" bgcolor="#558690" style="font-weight:bold; font-size:18px;">
								<td width="200px">
								DELEGACIÓN - ESPACIO PUBLICO
								</td>
								<td width="20%">
								NO. DE VALIDACIONES
								</td>
