...
//Declaramos las variables que vamos a user
	...
	jQuery(document).ready(function(){
	      ...
	      //Definimos algunas opciones del mapa a crear
	       var myOptions = {
	        ...
	        marker = new google.maps.Marker({
	            ...
	            icon:'resources/icons/point_aac1.png'
	        });
	    ...
	    function codeAddress() {
		    ...
		    if($("#id_delegacion option:selected").val()!="0")
            	delegacion = $("#id_delegacion option:selected").html();

		    if($("#id_colonia option:selected").val()!="0")
            	colonia = $("#id_colonia option:selected").html();
        	...
        	if(delegacion!='' || colonia!='' || calle!='' || numero!='')
        	{
        		//obtengo la direccion del formulario
        		var address = calle +" "+ numero + "," +colonia+ "," +delegacion;
                ...
                <div class="box box-solid box-success" style="text-align:left !important; min-height:260px; height:100%;">
   			     	<div class="box-body">
				            ...
				            <select name="id_tipo" id="id_tipo" class="form-control" >
			            		<option value="1">Delegacional</option>
			            ...
			            <div class="form-group">
			     		...
			     		<div class="form-group">
			     			<label>En caso de requerir, describa la logística:</label>
			            	<textarea name="logistica" id="logistica" class="form-control"/></textarea>				            
			            </div>
		            ...
		            <div class="row">
		            	...
		            	<div class="col-md-4">
				          ...
				          <input type="text" name="noAsistentes" id="noAsistentes" value="" class="form-control" >
			            </div>
			            
			            <div class="col-md-4">
			              <label>Promotores:</label>
				          <input type="text" name="noPromotores" id="noPromotores" value="" class="form-control" >
			            </div>
			            
			            <div class="col-md-4">
			              <label>Coordinadores:</label>
				          <input type="text" name="noCoordinadores" id="noCoordinadores" value="" class="form-control" >
			            </div>			            			            							
		            </div>		
	       	...
	       	<div class="box box-solid box-success" style="text-align:left !important; min-height:260px; height:100%;">
	       		<div class="box-body">
		            ...
		            <div class="row">
				        ...
				        <fieldset><legend class="titulos">Ubica aquí el Área de Actividad</legend></fieldset>
		             	<div class="row">
		            ...
		            <div class="row">
			         ...
			         <div class="row">
			            <div class="col-md-6">
		                    ...
		                    <input name="hora_inicio" id="hora_inicio" value="" class="form-control" type="text"/>
	                        
			            </div>
			            
			            <div class="col-md-6">
				             <label>Horas:</label>
				             <input type="text" name="num_horas" id="num_horas" value="" class="form-control"/>
			            </div>
			         </div>
		         </div>
