                ...
                <div class="box box-solid box-success" style="text-align:left !important; min-height:260px; height:100%;">
			          ...
			          -->
			          	<div class="form-group">
				            ...
				            <input type="text" name="nombre" id="nombre" value="<?php echo $dato['nombre'];?>" class="form-control" readonly>
			            </div>  
			            <div class="form-group">
				            ...
				            <input type="hidden"  name="id_delegacion" id="id_delegacion" value="<?php echo $dato['id_delegacion'];?>" class="form-control" readonly/>
			            </div>
			            ...
			            <div class="form-group">
			            	...
			            	<input type="text" name="descripcion" id="descripcion" value="<?php echo $dato['descripcion'];?>" class="form-control" readonly/>
			            </div>
			            <div class="form-group" id="involucrados"">
			            	<label>Delegaciones Involucradas:</label>
			            	<input type="text" name="involucrados" id="involucrados" value="<?php  foreach ($delegacion['id_evento'] as $del){echo ''.$del['delegacion'].', '; }?>" class="form-control" readonly>
				        </div>		            			               			     					            			            			           		             			           
			            <div class="form-group">
			            	<label>Actividad Seriada:</label>
			            	<input type="text" name="seriada" id="seriada" value="<?php echo $dato['seriada'];?>" class="form-control" readonly/>
						</div>
			            <div class="row">
			         ...
			         -->     
				             		...
				             		<td>
							            <div class="col-md-6">      
								     		<div class="form-group">
								     			...
								     			<?php } ?>			            	
								            	<div class="form-group" id="logistica" >
											            <select name="logistica[]" id="logistica[]" class="form-control"  disabled="true">
											            	<option value="0">[Seleccionar]</option>			            		
												            <?php 
								        ...
								        <div class="col-md-6">      
								     		<div class="form-group">
								     			...
								     			<?php } ?>			            	
								            	<div class="form-group" id="logistica" >
											         <input type="text" name="cantidad[]" id="cantidad" value="<?php echo $le['cantidad']; ?>" class="form-control" maxlength="4" readonly>
									            </div>		            
								            </div>
							           </div>
						           </td>
			            ...
			            <div class="row">
			            	...
			            	<div class="col-md-4">
					          ...
					          <input type="text" name="noAsistentes" id="noAsistentes" value="<?php echo $dato['no_asistentes'];?>" class="form-control" readonly>
				            </div>
				           
				            <div class="col-md-4">
				              <label>Coordinadores:</label>
					          <input type="text" name="noCoordinadores" id="noCoordinadores" value="<?php echo $dato['no_coordinadores'];?>" class="form-control" readonly>
				            </div>
				             
				            <div class="col-md-4">
				              <label>Promotores:</label>
					          <input type="text" name="noPromotores" id="noPromotores" value="<?php echo $dato['no_promotores'];?>" class="form-control" readonly>
				            </div>
	       		...
	       		<div class="box box-solid box-success" style="text-align:left !important; min-height:260px; height:100%;">
	       			<div class="box-body">
		            	...
		            	<div class="form-group">
			            	...
			            	<?php  if($dato['id_tipo_lugar'] == 1){?>
			            	<input type="text" name="id_tipo_lugar" id="id_tipo_lugar" value="<?php echo $dato['plantel'];?>" class="form-control" readonly>
				            <?php }elseif ($dato['id_tipo_lugar']==2){?>
				            <input type="text" name="id_tipo_lugar" id="id_tipo_lugar" value="<?php echo $dato['espacio_publico'];?>" class="form-control" readonly>
				            <?php }elseif ($dato['id_tipo_lugar']==3){?>
				            <input type="text" name="id_tipo_lugar" id="id_tipo_lugar" value="<?php echo $dato['museo'];?>" class="form-control" readonly>
				    	 	<?php }elseif ($dato['id_tipo_lugar']==4){?>
				            <input type="text" name="id_tipo_lugar" id="id_tipo_lugar" value="<?php echo $dato['escuela'];?>" class="form-control" readonly>
				    		<?php }?>
				    	</div>
		       			
		       			<div class="row">
			            	<div class="col-md-6">
					            <input class="textbox_insert" type="hidden" style="width: 97%;"  id="latbox" name="lat" value="" readonly />
	                        	<input class="textbox_insert" type="hidden" style="width: 97%;"  id="lonbox" name="lon" value="" readonly />
					        </div> 
				        </div>
		            ...
		            <br>
		     			<div class="row">
			            	<div class="col-md-4">
		                    	...
		                    	<input name="hora_inicio" id="hora_inicio" value="<?php echo $dato['horario'];?>" class="form-control" type="text" readonly/>
	                   		</div>
			            	<div class="col-md-4">
				            	<label>Horas:</label>
				             	<input type="text" name="num_horas" id="num_horas" value="<?php echo $dato['num_horas'];?>" class="form-control" readonly/>
			            	</div>
			         <!--    	<div  class="col-md-6">
				            	...
				            	<div class="input-group" style="width:135px;">
		                        	...
		                        	<input name="fecha_fin" id="fecha_fin" type="text" value="<?php echo $dato['fin'];?>" class="form-control pull-right dateP" onFocus="this.blur();"readonly/>
	                       		</div>
			            	</div>-->
			         	</div>
			            <br />
