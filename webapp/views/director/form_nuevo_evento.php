...
<section class="content">
 		...
 		<form id="registro" name="registro" method="post" action="index.php/director/guardaEvento">
	       	...
	       	<div class="box box-solid box-success" style="text-align:left !important; min-height:260px; height:100%;">
	       		<div class="box-body">
		            ...
		            <div class="form-group" id="div_involucrados" style="display:none;">
			            	...
			            	<fieldset><legend class="titulos">Delegaciones Involucradas<br />
				        <sub>(Para seleccionar varias delegaciones mantener presionada la tecla shift )</sub>
				        </legend>				        
				        </fieldset>
