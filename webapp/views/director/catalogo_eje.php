				 ...
				 if($('#nuevoEje').valid())
						     {
					             ...
					             $.ajax({
					                 type: 'POST',
					                 url: $('#nuevoEje').attr("action"),
					                 data: $('#nuevoEje').serialize(),
					                 success: function (data) {
					                     ...
					                     if(data === 'ok')
					                     {
					                    	 swal({
					                          	...
					                          	function(isConfirm){
					                          	  if (isConfirm) {
					                          		irA('index.php/director/cat_eje');
					                          	  } 
					                          	});
					                     }
					                     else
...
<div class="box">     
        ...
        <div class="pad20" style="text-align:left; width:90%;">
			...
			<div class="" style="width:90%">
			    <form action="index.php/director/updateCatalogo/" name="form_usuario" method="post" id="nuevoEje">
			        <table id="form_usr" border="0">
			             <tr>
			                <td colspan="1" style="text-align:right;">Eje Temático:</td>
			                <td colspan="2" style="text-align:left;">                   
			                    <input id="eje" name="eje" class="textbox_insert" type="text" style="width: 97%;" value="<?php echo $busca['eje_tematico'];?>"/></td>
							 	<input id="id_eje" name="id_eje" class="textbox_insert" type="hidden" style="width: 97%;" value="<?php echo $busca['id_eje'];?>"/></td>
							 	<input id="update" name="update" type="hidden" style="width: 97%;" value="eje"/></td>
		            		</td>
			                <td colspan="5">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>                 
			            </tr>
			            ...
			            <tr>    
			            	<td colspan="4" style="text-align:right; "> 
			                  ...
			                  <button id="cancelar" name="cancelar" type="button" class="btn btn-small" onclick="irA('index.php/director/cat_eje')">Cancelar</button>
