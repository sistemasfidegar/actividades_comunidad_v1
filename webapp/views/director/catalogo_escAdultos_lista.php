...
$().ready(function () {
	...
	$("#guardar").click(function ()
			{ 
				 if($('#nuevaEscuela').valid())
						     {
								 $.blockUI({message: 'Procesando por favor espere...'});
					             $.ajax({
					                 type: 'POST',
					                 url: $('#nuevaEscuela').attr("action"),
					                 data: $('#nuevaEscuela').serialize(),
					                 success: function (data) {
					                     ...
					                     if(data === 'ok')
					                     {
					                    	 ...
					                    	 swal({
					                          	...
					                          	function(isConfirm){
					                          	  if (isConfirm) {
					                          		irA('index.php/director/cat_escAdultos');
					                          	  } 
					                          	});
					                     }
					                     else
...
<section class="content-header">
   <label><h2> Escuela para Adultos Mayores</h2></label>  
...
<section class="content">
	...
	<div id="desliza" class="box box-solid box-success" style="display:none;width:100%;">
		<form action="index.php/director/guardaCatalogo/" name="nuevaEscuela" method="post" id="nuevaEscuela">
		     <table id="form_coo" border="0">
	 				<tr><td colspan="5">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td></tr>			            
			        <tr>
			            <td colspan="1" style="text-align:right;">Nombre:</td>
			            <td colspan="2" style="text-align:left;">
			            	<input id="NombreEsc" name="NombreEsc" class="textbox_insert" type="text" style="width: 97%;" value="" />
		           ...
		           <tr>
			            ...
			            <td colspan="2" style="text-align:left;">
			            	<input id="Direccion" name="Direccion" class="textbox_insert" type="text" style="width: 97%;" value="" />
			            </td>
		                <td colspan="5">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>                 
		            </tr>
		             <tr>
            ...
            <div class="box box-solid box-success" style="text-align:left !important; min-height:260px; height:100%;">
            		...
            		<table id ="Ejes" class="table table-bordered table-striped" cellpadding="0" cellspacing="0" border="1" style="min-width:612px; width:100%;"> <!-- table-hover table-condensed -->
			        	...
			        	<?php 
							...
							$i++;
						?>
							<tr onClick="location.href='index.php/director/buscaEsc/<?php echo $data['id_escuela_adulto']?>'" style="cursor:pointer;">
								<td><?php echo $i?></td>
