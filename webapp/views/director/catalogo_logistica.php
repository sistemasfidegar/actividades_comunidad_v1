...
$().ready(function () {
	...
	$("#guardar").click(function ()
			{ 
				 if($('#nuevologistica').valid())
						     {
								 $.blockUI({message: 'Procesando por favor espere...'});
					             $.ajax({
					                 type: 'POST',
					                 url: $('#nuevologistica').attr("action"),
					                 data: $('#nuevologistica').serialize(),
					                 success: function (data) {
					                     ...
					                     if(data === 'ok')
					                     {
					                    	 swal({
					                          	...
					                          	function(isConfirm){
					                          	  if (isConfirm) {
					                          		irA('index.php/director/cat_logistica');
					                          	  } 
					                          	});
					                     }
					                     else
...
<div class="box">     
        ...
        <div class="pad20" style="text-align:left; width:90%;">
			...
			<div class="" style="width:90%">
			    <form action="index.php/director/updateCatalogo/" name="form_usuario" method="post" id="nuevologistica">
			        <table id="form_usr" border="0">
			             <tr>
			                <td colspan="1" style="text-align:right;">Logistica:</td>
			                <td colspan="2" style="text-align:left;">                   
			                    <input id="logistica" name="logistica" class="textbox_insert" type="text" style="width: 97%;" value="<?php echo $busca['logistica'];?>"/></td>
							 	<input id="id_logistica" name="id_logistica" class="textbox_insert" type="hidden" style="width: 97%;" value="<?php echo $busca['id_logistica'];?>"/></td>
							 	<input id="update" name="update" type="hidden" style="width: 97%;" value="logistica"/></td>
		            		</td>
			                <td colspan="5">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>                 
			            </tr>
			            ...
			            <tr>    
			            	<td colspan="4" style="text-align:right; "> 
			                  ...
			                  <button id="cancelar" name="cancelar" type="button" class="btn btn-small" onclick="irA('index.php/director/cat_logistica')">Cancelar</button>
