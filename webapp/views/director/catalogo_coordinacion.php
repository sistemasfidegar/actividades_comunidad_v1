...
<div class="box">     
        ...
        <div class="pad20" style="text-align:left; width:90%;">
			...
			<div class="" style="width:90%">
			    <form action="index.php/director/updateCatalogo/" name="nuevaCoordinacion" method="post" id="nuevaCoordinacion">
			        <table id="form_coo" border="0">
			            <tr>
			                <td colspan="1" style="text-align:right;">Siglas:</td>
			                <td colspan="2" style="text-align:left;">                   
			                    <input id="siglas" name="siglas" class="textbox_insert" type="text" style="width: 97%;" value="<?php echo $busca['siglas'];?>"/></td>
							</td>
			                <td colspan="5">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>                 
			            </tr>
			             <tr>
			                <td colspan="1" style="text-align:right;">Coordinación:</td>
			                <td colspan="2" style="text-align:left;">                   
			                    <input id="coordinacion" name="coordinacion" class="textbox_insert" type="text" style="width: 97%;" value="<?php echo $busca['coordinacion'];?>"/></td>
							 	<input id="id_coordinacion" name="id_coordinacion" class="textbox_insert" type="hidden" style="width: 97%;" value="<?php echo $busca['id_coordinacion'];?>"/></td>
							 	<input id="update" name="update" type="hidden" style="width: 97%;" value="coordinacion"/></td>
		            		</td>
			                <td colspan="5">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>                 
			            </tr>
			            ...
			            <tr>    
			            	<td colspan="4" style="text-align:right; "> 
			                  ...
			                  <button id="cancelar" name="cancelar" type="button" class="btn btn-small" onclick="irA('index.php/director/cat_coordinacion')">Cancelar</button>
