				 ...
				 if($('#nuevaEsc').valid())
						     {
					             ...
					             $.ajax({
					                 type: 'POST',
					                 url: $('#nuevaEsc').attr("action"),
					                 data: $('#nuevaEsc').serialize(),
...
<div class="box">     
        ...
        <div class="pad20" style="text-align:left; width:90%;">
			...
			<div class="" style="width:90%">
			    <form action="index.php/director/updateCatalogo/" name="nuevaEsc" method="post" id="nuevaEsc">
			        <table id="form_coo" border="0">
			            <tr>
			                <td colspan="1" style="text-align:right;">Escuela:</td>
			                <td colspan="2" style="text-align:left;">                   
			                    <input id="nombre" name="nombre" class="textbox_insert" type="text" style="width: 97%;" value="<?php echo $busca['escuela'];?>"/></td>
							</td>
			                <td colspan="5">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>                 
			            </tr>
			             <tr>
			                ...
			                <td colspan="2" style="text-align:left;">                   
			                    <input id="direccion" name="direccion" class="textbox_insert" type="text" style="width: 97%;" value="<?php echo $busca['direccion'];?>"/></td>
							 	<input id="id_escuela" name="id_escuela" class="textbox_insert" type="hidden" style="width: 97%;" value="<?php echo $busca['id_escuela_adulto'];?>"/></td>
							 	<input id="update" name="update" type="hidden" style="width: 97%;" value="escuela"/></td>
		            		</td>
			                <td colspan="5">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>                 
			            </tr>
			           <tr>
