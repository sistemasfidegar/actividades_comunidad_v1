...
function updateEvento($datos){
    	$this->sql="UPDATE evento set  id_eje=:id_eje, descripcion=:descripcion, id_coordinacion=:id_coordinacion,id_tipo_lugar=:id_tipo_lugar, latitud=:latitud, longitud=:longitud,
    						...
    						id_actividad=:actividad, responsable_actividad=:res_actividad, nombre=:nombre	
    ...
    {
    	$this->sql = "INSERT INTO evento (id_tipo_evento,id_eje,descripcion,id_coordinacion,id_seriada,id_tipo_lugar,id_lugar,fecha_inicio,fecha_fin,horario,num_horas,no_asistentes,no_coordinadores,no_promotores,id_usuario_registra, id_responsable,id_delegacion,latitud,longitud, activo, id_actividad, responsable_actividad,nombre) values
   			(1,:id_eje,:descripcion,:id_coordinacion,:id_seriada,:id_tipo_lugar,:id_lugar,:fecha_inicio,:fecha_inicio,:horario,:num_horas,:no_asistentes,:no_coordinadores,:no_promotores,:id_usuario_registra, :id_responsable,:id_delegacion,:latitud,:longitud,  't', :actividad, :res_actividad, :nombre) returning id_evento;";
